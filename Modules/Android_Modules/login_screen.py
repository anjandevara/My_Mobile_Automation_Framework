...
class TestSenderLoginScreenA(FindElements):
    # --------------------- LOGIN FIELDS VERIFICATION SECTION ---------------------

    def get_login_username(self):
        user_mail = self.find_element_by_id(login_screen["phone_number"]).get_attribute("text")
        return user_mail

    def get_login_password(self):
        user_password = self.find_element_by_id(login_screen["password"]).get_attribute("text")
        return user_password

    def enter_username(self, username):

        username_textbox = self.find_element_by_id(login_screen["phone_number"])
    ...
    def enter_password(self, password):
        ...
        password_textbox = self.find_element_by_id(login_screen["password"])
    ...
    def verify_Login_Button(self):
        ...
        login_button = self.find_element_by_id(login_screen["sign_in_button"])
        assert login_button
    ...
    #     rememberme_checkbox = self.find_element_by_id("")
    ...
    #     WebDriverWait(self.driver, 50).until(EC.presence_of_element_located((By.ID, "")))
    #     HideUnhide_button_state = self.find_element_by_id("")
